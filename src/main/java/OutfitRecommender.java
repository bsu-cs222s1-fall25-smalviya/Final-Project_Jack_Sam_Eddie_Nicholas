public class OutfitRecommender {
    ...
    protected void temperatureFahrenheitOutfitRecommender(){
        if (0<=fahrenheit && fahrenheit <= 5) {
            System.out.println("Fahrenheit Outfit Recommender found!");
        }
    }

    protected void temperatureCelsiusOutfitRecommender(){
        if (0<=celsius && celsius <= 5) {
            string temperatureCelsiusOutfitRecommender = "It is recommend to wear ";
        }
    }

    protected void shortForecastOutfitRecommender(){
